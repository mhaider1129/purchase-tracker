...
test('renders analytical sections, values, missing coverage and sends filters',async()=>{
 getPerformanceDashboard.mockResolvedValue({data:{metrics:{demand:{requested_items:{value:null,coverage:'LEGACY_INCOMPLETE',status:'not_available',reason:'Legacy evidence incomplete'}},complexity:{mix:[{class:'D',count:2}]}},buyers:[{buyer_id:1,buyer_name:'Buyer A',workload_units:7}],pending:[{root_cause:'CUSTOMS_REGULATORY',count:1}],highlights:[{case_id:4,summary:'OEM sourced'}]}});
