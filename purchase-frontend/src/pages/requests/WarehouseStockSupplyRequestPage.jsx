...
const WarehouseStockSupplyRequestPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    payload.append('request_type', 'Warehouse Stock Supply');
    ...
    try {
      ...
      navigate('/request-submitted', { state: { requestType: 'Warehouse Stock Supply' } });
    } catch (err) {
  ...
  return (
    <>
      ...
      <div className="max-w-3xl mx-auto p-6">
        <h1 className="text-2xl font-bold mb-4">Warehouse Stock Supply Request</h1>
...
export default WarehouseStockSupplyRequestPage;