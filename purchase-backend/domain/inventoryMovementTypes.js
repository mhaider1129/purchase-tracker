...
const INVENTORY_MOVEMENT_TYPES = Object.freeze({
  ...
  TRANSFER_DISPATCH: definition('OUT', { requiresDestinationWarehouse: true, permission: 'inventory.transfer' }),
  TRANSFER_RECEIPT: definition('IN', { requiresDestinationWarehouse: true, permission: 'inventory.transfer' }),
  ...
  QUARANTINE: definition('STATUS', { changesStockStatus: true, requiresReason: true, permission: 'inventory.adjust' }),
  RELEASE_FROM_QUARANTINE: definition('STATUS', { changesStockStatus: true, requiresReason: true, permission: 'inventory.adjust' }),
});
