...
ALTER TABLE public.ap_payables ADD COLUMN IF NOT EXISTS ap_voucher_id BIGINT REFERENCES public.ap_vouchers(id);
ALTER TABLE public.finance_postings ADD COLUMN IF NOT EXISTS supplier_invoice_id BIGINT REFERENCES public.supplier_invoices(id);
ALTER TABLE public.finance_postings ADD COLUMN IF NOT EXISTS idempotency_key TEXT;
