...
-- The catalog writes below are restart-safe so an operator can rerun 010 after a
-- successful execution (or resume after objects were created outside this transaction).
