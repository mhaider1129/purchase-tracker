...
BEGIN
  ...
  -- A compatible installation is a successful no-op. Do not raise an exception here:
  -- Supabase/PostgREST reports user-raised P0001 exceptions as failed SQL queries.
  RETURN;
END $$;
