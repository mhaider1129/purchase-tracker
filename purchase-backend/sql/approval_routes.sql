...
VALUES
  ...
  (43, 'IT Item', 'medical', 1, 'requester', 0, 999999999),
  (44, 'IT Item', 'medical', 2, 'HOD', 0, 999999999),
  (45, 'IT Item', 'medical', 3, 'IT Department HOD', 0, 999999999),
  (46, 'IT Item', 'medical', 4, 'CMO', 0, 999999999),
  (47, 'IT Item', 'medical', 5, 'SCM', 0, 999999999),
  (48, 'IT Item', 'medical', 7, 'COO', 0, 999999999),
  ...
  (55, 'IT Item', 'medical', 6, 'CFO', 5000001, 999999999),
  (56, 'IT Item', 'operational', 5, 'CFO', 5000001, 999999999),
  (59, 'IT Item', 'operational', 1, 'requester', 0, 999999999),
  (60, 'IT Item', 'operational', 2, 'HOD', 0, 999999999),
  (61, 'IT Item', 'operational', 3, 'IT Department HOD', 0, 999999999),
  (62, 'IT Item', 'operational', 4, 'SCM', 0, 999999999),
  (63, 'IT Item', 'operational', 6, 'COO', 0, 999999999),
