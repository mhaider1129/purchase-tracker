...
| Stock item master | Item catalog | `stock_items` | `/api/stock-items` | `ItemMasterPage` | **Master Data** | Warehouse inventory, requested items | **Keep + enforce canonical inventory integration** |
