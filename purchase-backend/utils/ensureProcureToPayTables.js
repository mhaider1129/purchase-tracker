...
const statements = [
  ...
  `CREATE TABLE IF NOT EXISTS public.purchase_orders (
    ...
    supplier_name TEXT,
    source_document_type TEXT NOT NULL DEFAULT 'PURCHASE_REQUEST',
  ...
  `ALTER TABLE public.purchase_orders ADD COLUMN IF NOT EXISTS source_document_type TEXT NOT NULL DEFAULT 'PURCHASE_REQUEST'`,
  `ALTER TABLE public.purchase_orders ADD COLUMN IF NOT EXISTS source_document_id TEXT`,
  `ALTER TABLE public.purchase_orders ADD COLUMN IF NOT EXISTS contract_reference TEXT`,
  `ALTER TABLE public.purchase_orders ADD COLUMN IF NOT EXISTS expected_delivery_date DATE`,
  `ALTER TABLE public.purchase_orders ADD COLUMN IF NOT EXISTS delivery_location TEXT`,
  `ALTER TABLE public.purchase_orders ADD COLUMN IF NOT EXISTS budget_cost_center TEXT`,
  `ALTER TABLE public.purchase_orders ADD COLUMN IF NOT EXISTS tax_terms TEXT`,
  ...
  `ALTER TABLE public.purchase_orders ADD COLUMN IF NOT EXISTS supplier_contact_email TEXT`,
  `ALTER TABLE public.purchase_orders ADD COLUMN IF NOT EXISTS approval_required BOOLEAN NOT NULL DEFAULT FALSE`,
  `ALTER TABLE public.purchase_orders ADD COLUMN IF NOT EXISTS approval_route TEXT`,
  `ALTER TABLE public.purchase_orders ADD COLUMN IF NOT EXISTS approved_by INTEGER REFERENCES public.users(id)`,
  `ALTER TABLE public.purchase_orders ADD COLUMN IF NOT EXISTS approved_at TIMESTAMPTZ`,
  `ALTER TABLE public.purchase_orders ADD COLUMN IF NOT EXISTS issue_event_at TIMESTAMPTZ`,
  `ALTER TABLE public.purchase_orders ADD COLUMN IF NOT EXISTS issued_to_supplier_at TIMESTAMPTZ`,
  `ALTER TABLE public.purchase_orders ADD COLUMN IF NOT EXISTS cancellation_reason TEXT`,
  `ALTER TABLE public.purchase_orders ADD COLUMN IF NOT EXISTS amendment_reason TEXT`,
  `ALTER TABLE public.purchase_orders ADD COLUMN IF NOT EXISTS last_amended_at TIMESTAMPTZ`,
