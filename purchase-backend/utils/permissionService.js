...
const DEFAULT_ROLE_PERMISSIONS = {
  ...
  scm: [
    ...
    'item-master.create',
    'item-master.edit',
    'item-master.validate',
    'item-master.retire',
    'item-master.map',
    'item-master.products',
    'item-master.products.approve',
    'item-master.suppliers',
    'item-master.legacy-maintain',
    'item-master.free-text-exception',
    'users.manage',
    'warehouse.manage-supply',
    'warehouse.view-supply',
    'dashboard.view',
...
const CORE_PERMISSION_DEFINITIONS = [
  ...
  {
    code: 'risks.view',
    name: 'View risk register',
    description: 'View organizational risks and mitigations.',
  },
  {
    code: 'risks.manage',
    name: 'Manage risks',
  ...
  { code: 'item-master.create', name: 'Create generic items', description: 'Create governed generic item drafts' },
  { code: 'item-master.edit', name: 'Edit generic items', description: 'Edit generic item master records' },
  { code: 'item-master.validate', name: 'Validate generic items', description: 'Validate structured generic item records' },
  { code: 'item-master.retire', name: 'Retire generic items', description: 'Retire active generic items' },
  { code: 'item-master.map', name: 'Resolve item mappings', description: 'Resolve pending and duplicate mappings' },
  { code: 'item-master.products', name: 'Manage approved products', description: 'Create and maintain approved products' },
  { code: 'item-master.products.approve', name: 'Approve products', description: 'Approve exact manufactured products' },
