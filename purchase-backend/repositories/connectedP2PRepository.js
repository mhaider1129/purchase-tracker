...
const createConnectedP2PRepository = (client) => ({
  ...
  insertApPayable: (p) => one(client,`INSERT INTO ap_payables (request_id,supplier_invoice_id,supplier_name,invoice_total,open_balance,payable_status,posted_by) VALUES ($1,$2,$3,$4,$5,'OPEN',$6) RETURNING *`,[p.request_id,p.supplier_invoice_id,p.supplier_name,p.invoice_total,p.open_balance,p.posted_by]),
